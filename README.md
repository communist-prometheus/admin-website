...
Deployed on Cloudflare Workers. The CORS proxy lives in-app at `/api/cors/*` (see `src/api/cors-proxy.ts`) and proxies git operations to GitHub from the same origin.
