...
test.describe('Content Creation', () => {
  ...
  test('should show correct fields for blog content creation', async ({ page }) => {
    await page.goto('/content/blog')
    await page.waitForLoadState('networkidle')
    await page.click('button:has-text("New")')
  ...
  test('should show correct fields for positions content creation', async ({ page }) => {
    await page.goto('/content/positions')
    await page.waitForLoadState('networkidle')
    await page.click('button:has-text("New")')
  ...
  test('should show correct fields for pages content creation', async ({ page }) => {
    await page.goto('/content/pages')
    await page.waitForLoadState('networkidle')
    await page.click('button:has-text("New")')
  ...
  test('should create new content when form is submitted', async ({ page }) => {
    await page.goto('/content/blog')
    await page.waitForLoadState('networkidle')
    await page.click('button:has-text("New")')
