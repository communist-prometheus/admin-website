...
test.describe('Authentication Required', () => {
  test('should redirect to home when accessing blog without auth', async ({ page }) => {
  ...
  test('should redirect to home when accessing positions without auth', async ({ page }) => {
  ...
  test('should redirect to home when accessing pages without auth', async ({ page }) => {
  ...
  test('should show login message on content pages without auth', async ({ page }) => {
    await page.goto('/content/blog')
    await waitForNetworkIdle(page)
  ...
  test('should not load content from API without authentication', async ({ page }) => {
